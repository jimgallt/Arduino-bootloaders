...
/**********************************************************
 * Edit History:
 * 4.1 WestfW: clear R1 at startup, move length and address to
 *             registers to save space.
 * 4.2 WestfW: put version number in binary.
 ***************************************************************/

// Version 3 was released as zip.  Version 4 starts with the 11-may
// changed that included the NRWW section..
#define OPTIBOOT_MAJVER 4

// Version 1 is westfw and changes...
